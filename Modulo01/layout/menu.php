            ...
            <div class="sidebar-wrapper active ps">
                ...
                <div class="sidebar-menu">
                    ...
                    <ul class="menu ms-3">
                        ...
                        <li class="sidebar-item">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="Topico01.php" class="MenuTopico sidebar-link <?php if($page=='Topico01'){echo'ativo';}?>"><span id="menuNumero">01 </span>As Compras Governamentais Como Oportunidade Para os Pequenos Negócios </a>
                            </div>
                        </li>

                        <li class="sidebar-item">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="Topico02.php" class="MenuTopico sidebar-link <?php if($page=='Topico02'){echo'ativo';}?>"><span id="menuNumero">02 </span>A Legislação das Compras Governamentais </a>
                            </div>
                        </li>

                        <li class="sidebar-item">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="Topico03.php" class="MenuTopico sidebar-link <?php if($page=='Topico03'){echo'ativo';}?>"><span id="menuNumero">03 </span>O Que Fazer ao Decidir Participar das Compras da Administração Pública </a>
                            </div>
                        </li>

                        <li class="sidebar-item">
                            <div class="bd-callout-menu bd-callout-success-menu">
                                <a href="Topico04.php" class="MenuTopico sidebar-link <?php if($page=='Topico04'){echo'ativo';}?>"><span id="menuNumero">04 </span>O Cadastramento do Fornecedor na Administração Pública </a>
                            </div>
                        </li>
